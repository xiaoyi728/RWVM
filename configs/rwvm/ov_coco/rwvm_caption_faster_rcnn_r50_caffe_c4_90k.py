...
model = dict(
    ...
    batch2ovd=dict(caption_batch='rwvm_caption'),
    roi_head=dict(
        ...
        #         checkpoint='checkpoints/resnet50_msra-5891d200.pth')),
        clip_cfg=clip_cfg,
        ovd_cfg=dict(rwvm_caption=ovd_cfg),
        bbox_head=dict(
            type='RWVMBBoxHead',
            ...
            cls_bias=-20.0,
            cls_temp=25.0,
            cls_embeddings_path='/home/cy518/program/ovdet-main_1/data/metadata/coco_clip_hand_craft_attn12.npy',
