...
from .convfc_bbox_head import RWVMConvFCBBoxHead
...
class EnsembleRWVMConvFCBBoxHead(RWVMConvFCBBoxHead):
...
@MODELS.register_module()
class EnsembleRWVMShared2FCBBoxHead(EnsembleRWVMConvFCBBoxHead):
...
@MODELS.register_module()
class EnsembleRWVMShared4Conv1FCBBoxHead(EnsembleRWVMConvFCBBoxHead):
    def __init__(self, fc_out_channels: int = 1024, *args, **kwargs) -> None:
        super().__init__(
            num_shared_convs=4,
            num_shared_fcs=1,
