...
from .bbox_head import RWVMBBoxHead


@MODELS.register_module()
class RWVMConvFCBBoxHead(RWVMBBoxHead):
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(RWVMConvFCBBoxHead, self).train(mode)
...
@MODELS.register_module()
class RWVMShared2FCBBoxHead(RWVMConvFCBBoxHead):
...
@MODELS.register_module()
class RWVMShared4Conv1FCBBoxHead(RWVMConvFCBBoxHead):
